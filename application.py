...
@app.route('/category/<int:category_id>/item/<int:category_item_id>/JSON')
...
# show a specific items of category
...
def showCategoryItem(category_id, category_item_id):
    ...
    creator = getUserInfo(category.user_id)
    return render_template(
        'category_item_description.html',
...
def newCategoryItem():
    ...
    if request.method == 'POST':
        addNewCategoryItem = CategoryItem(
            ...
            user_id=login_session['user_id'])
        session.add(addNewCategoryItem)
        session.commit()
...
def editCategoryItem(category_id, category_item_id):
    ...
    if request.method == 'POST':
        ...
        if request.form['category']:
            editedCategoryItem.category = request.form['category']
...
def deleteCategoryItem(category_id, category_item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'delete_Category_item.html', item=CategoryitemToDelete)
